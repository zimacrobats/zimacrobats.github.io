    ...
    var l = {
      ...
      loadContent: function () {
        function a(a) {
          var d,
          e = '';
          if ('function' === typeof b.options.jsonSuccess) b.options.jsonSuccess.apply(this, [
            a
          ]);
           else {
      ...
      goTo: function (a, b, e) {
        ...
        'function' === typeof c.options.beforeMove && c.options.beforeMove.apply(this, [
          c.$elem
        ]);
      ...
      gestures: function () {
        ...
        function e(b) {
          ...
          'function' === typeof d.options.startDragging && !0 !== h.dragging && 0 !== d.newRelativeX && (h.dragging = !0, d.options.startDragging.apply(d, [
            d.$elem
          ]));
